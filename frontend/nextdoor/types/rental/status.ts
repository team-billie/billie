...
export const RENTAL_STATUS = {
  ...
  BEFORE_PHOTO_REGISTERED: "BEFORE_PHOTO_REGISTERED", // 2.대여 시 Owner가 물품 사진 업로드한 후 시점
  REMITTANCE_REQUESTED: "REMITTANCE_REQUESTED", // 3.Renter의 결제(송금) 요청 시점
  REMITTANCE_CONFIRMED: "REMITTANCE_CONFIRMED", // 4.Renter의 결제(송금) 완료 시점
  RENTAL_PERIOD_ENDED: "RENTAL_PERIOD_ENDED", // 5.대여 끝난 시점
  AFTER_PHOTO_REGISTERED: "AFTER_PHOTO_REGISTERED", // 6.반납시 Renter가 물품 사진 업로드한 후 시점
  DEPOSIT_REQUESTED: "DEPOSIT_REQUESTED", // 7.보증금 처리 요청된 시점
